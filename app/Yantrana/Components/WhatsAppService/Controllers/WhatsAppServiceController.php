...
class WhatsAppServiceController extends BaseController
{
    ...
    */
     ...
     * @return json
     */
    public function getContactChatData($contactUid)
    {
        validateVendorAccess('messaging');
        $processReaction = $this->whatsAppServiceEngine->contactChatData($contactUid);
        updateClientModels([
            'whatsappMessageLogs' => $processReaction->data('whatsappMessageLog'),
        ], 'extend');
     ...
     * @return void
     */
    public function getContactsData($contactUid = null)
    {
        validateVendorAccess('messaging');
        $processReaction = $this->whatsAppServiceEngine->contactsData($contactUid);
        updateClientModels([
            'contacts' => $processReaction->data('contacts'),
        ]);
    ...
    public function deleteTemplate(BaseRequestTwo $request, $whatsappTemplateId)
    {
        ...
        // ask engine to process the request
        $processReaction = $this->whatsAppServiceEngine->processDeleteTemplate($whatsappTemplateId);
    ...
    public function prepareTemplatesList()
    {
        ...
        return $this->whatsAppServiceEngine->prepareTemplatesDataTableSource();
    }
    ...
    public function syncTemplates()
    {
        ...
        return $this->processResponse(
            $this->whatsAppServiceEngine->processSyncTemplates(),
            [],
            [],
            true
        );
