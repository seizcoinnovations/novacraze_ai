@extends('layouts.app', ['title' => __tr('Subscription')])
@section('content')
    @include('users.partials.header', [
    'title' => __tr('Subscription'),
    'description' => '',
    'class' => 'col-lg-7'
    ])
                   ...
                   <div class="card-body">
                       ...
                       @if ($currentPlan and ($isManualSubscription or $subscriber->subscribed($currentPlan['id'])))
                           ...
                           @if ($currentSubscription->ends_at ?? null)
                               <h4 class="text-orange">{{  __tr('Your Plan will expire on __expiryDate__', [
               ...
               @if ($currentPlan and $hasPlansForPurchase)
                   <div class="card">
                       ...
                       <div class="card-body" x-data="{selectedPlanFrequencyNew:null}">
                               ...
                               <fieldset>
                                <legend>{{  __tr('Manual Subscription') }}</legend>
                               ...
                               <div class="form-group">
                                   ...
                                   <fieldset>
                                    <legend for="card-element">
                                        ...
                                        <form action="{{ route('subscription.write.create') }}" method="post" id="payment-form"
