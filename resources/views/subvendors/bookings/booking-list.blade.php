@extends('layouts.app', ['title' => __tr('Subvendors - Bookings')])
...
<div class="container-fluid">
    @php
        $allotted_booking_count = getUserAuthInfo('subscription_details')['booking_management_count'];
    @endphp
    @if ($totalBookingCount>=$allotted_booking_count)
        <div class="alert alert-danger">
                {{  __tr('Limit exceeded, please upgrade your plan to add more Bookings') }}
                <br>
        </div>
    @endif
</div>
...
<div class="container-fluid">
    ...
    <!-- /VENDOR DELETE TEMPLATE -->
    {{-- ADD BOOKING MODAL --}}
    <x-lw.modal id="addBookingModal" :header="__tr('Add New Booking')" :hasForm="true">
        {{-- FORM START --}}
            ...
            <div class="lw-form-modal-body">
                ...
                <div class="form-group mb-3">
                    <div class="input-group input-group-alternative">
                        ...
                        <input class="form-control" placeholder="{{ __tr('Product') }}" type="text"
                ...
                <div class="form-group mb-3">
                    <div class="input-group input-group-alternative">
                        ...
                        <input class="form-control" placeholder="{{ __tr('Booking Date') }}" type="date" name="booking_date"
                            value="{{ old('booking_date') }}" required autofocus>
                    </div>
                </div>
                {{-- USERNAME --}}
                {{-- FIRSTNAME --}}
                <div class="form-group mb-3">
                    <div class="input-group input-group-alternative">
                        ...
                        <input class="form-control" placeholder="{{ __tr('WA Number') }}" type="text" name="wa_number"
                            value="{{ old('wa_number') }}" required>
                    </div>
                </div>
                {{-- FIRSTNAME --}}
                {{-- LASTNAME --}}
                <div class="form-group mb-3">
                    <div class="input-group input-group-alternative">
                        ...
                        <textarea class="form-control" placeholder="{{ __tr('Comments') }}" name="comments" value="{{ old('comments') }}" required></textarea>
