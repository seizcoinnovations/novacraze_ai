...
'title' => __tr('SubVendors') . ' '. auth()->user()->name,
'description' => '',
'class' => 'col-lg-7'
])
...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-12 mb-3 mt-md--5">
            <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#addsubVendorModal">
                <?= __tr('Add New SubVendor') ?>
            </button>
        </div>
        <div class="col-xl-12">
            {{-- DATATABLE --}}
            <x-lw.datatable id="lwManageVendorsTable"  data-page-length="100">
    ...
    <!-- /VENDOR DELETE TEMPLATE -->
    {{-- ADD VENDOR MODAL --}}
    <x-lw.modal id="addsubVendorModal" :header="__tr('Add New Subvendor')" :hasForm="true">
        {{-- FORM START --}}
        <x-lw.form :action="route('central.subvendors.write.add')" data-callback="afterSuccessfullyCreated">
            <div class="lw-form-modal-body">
                ...
                <div class="form-group mb-3">
                    <div class="input-group input-group-alternative">
                        ...
                        <input class="form-control" placeholder="{{ __tr('Subvendor Title') }}" type="text"
                            name="subvendor_title" value="{{ old('subvendor_title') }}" required>
                    </div>
                </div>
                {{-- VENDOR TITLE --}}
                {{-- USERNAME --}}
                ...
                <div class="form-group mb-3">
                    <div class="input-group input-group-alternative">
                        ...
                        <input class="form-control" placeholder="{{ __tr('Phone') }}" type="text" name="phone" required >
                    </div>
                </div>
                {{-- /PHONE --}}
